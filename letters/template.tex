...
\ThisU$if(letterhead-side)$$letterhead-side$$else$L$endif$CornerWallPaper{$if(letterhead-scale)$$letterhead-scale$$else$1$endif$}{$letterhead$}
$endif$

$if(letterfoot)$
\usepackage{wallpaper}
\ThisL$if(letterfoot-side)$$letterfoot-side$$else$L$endif$CornerWallPaper{$if(letterfoot-scale)$$letterfoot-scale$$else$1$endif$}{$letterfoot$}
$endif$
