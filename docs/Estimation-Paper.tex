...
\begin{figure}
\includegraphics[width=1\linewidth]{Estimation-Paper_files/figure-latex/est-eff-plots-1} \caption{Effect plot of some interactions of the multivariate linear model corresponding to \emph{error model}}\label{fig:est-eff-plots}
\end{figure}
