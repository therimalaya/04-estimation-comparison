...
\begin{figure}
\includegraphics[width=1\linewidth]{Estimation-Paper_files/figure-latex/coef-plot-1} \caption{Regression Coefficients estimated by PLS2 and Simultaneous methods on the data based on Design 9 and 29.}\label{fig:coef-plot}
\end{figure}
...
\centering
\begin{tabu} to \linewidth {>{\raggedleft}X>{\raggedleft}X>{\raggedleft}X>{\em}r>{\em}r>{\raggedleft}X>{\raggedleft}X}
\toprule
