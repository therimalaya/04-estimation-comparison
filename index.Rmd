...
Principal Components are defined as a transformation of the dataset into a new
set of variables called principal components. These components are uncorrelated
and the variation in the original data are ordered from first to last of these
