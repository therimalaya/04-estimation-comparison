...
(\#eq:eta)
\end{equation}
: Four levels  `r catvec(opts$eta)` of `eta` are used in the simulations. Level $\kappa=`r opts$eta[1]`$ gives data with uncorrelated response variables, while $\kappa=`r opts$eta[length(opts$eta)]`$ gives highly correlated response variables.
